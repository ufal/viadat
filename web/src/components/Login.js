...
class Login extends Component {
    ...
    constructor(props) {
        super(props);
        this.state = {username: "test", password: "test", error: null, logged: false};
    }
    ...
    render() {
        ...
        <FormControl
            ...
            onChange={(e) => this.setState(update(this.state, {username: {$set: e.target.value}}))}
        />
        ...
        <FormControl
            ...
            onChange={(e) => this.setState(update(this.state, {password: {$set: e.target.value}}))}
        />
        </FormGroup>
